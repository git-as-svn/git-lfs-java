...
public class ClientLegacyTest {
  ...
  public void legacyDownload01() throws IOException {
    ...
    final Client client = new Client(new FakeAuthProvider(), replay);
    final byte[] data = client.getObject("b810bbe954d51e380f395de0c301a0a42d16f115453f2feb4188ca9f7189074e", new ByteStreamHandler());
  ...
  public void legacyDownload02() throws IOException {
    ...
    final Client client = new Client(new FakeAuthProvider(), replay);
    try {
      client.getObject("01ba4719c80b6fe911b091a7c05124b64eeece964e09c058ef8f9805daca546b", new ByteStreamHandler());
      Assert.fail();
